...
describe('Questionnaire routing resolve service', () => {
  ...
  let resultQuestionnaire: IQuestionnaire | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultQuestionnaire).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IQuestionnaire>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
